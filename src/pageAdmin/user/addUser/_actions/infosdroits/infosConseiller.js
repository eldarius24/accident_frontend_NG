// Layout/Admin/User/_actions/infosdroits/infosConseiller.js
import React from 'react';
import { useTheme } from '../../../../../Hook/ThemeContext';

const InfosConseiller = () => {
      ...
      <div className="space-y-6">
        <div className="rounded-lg shadow-md overflow-hidden" style={cardStyles}>
          <h2 className="text-xl font-semibold p-4" style={headerStyles}>
            Droits conseiller en prévention
          </h2>
          <div className="p-4" style={itemStyles}>
            <p>Le conseiller en prévention un accès partiel au site, notamment :</p>
...
export default InfosConseiller;