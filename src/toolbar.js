        ...
        <Box sx={{
          ...
          {isAllAcces && (
            <>
              ...
              {!['/', '/signatures', '/statistiquesVehicules', '/fichierdll', '/modifVehicule', '/formulaire', '/gestionVehicules', '/AdminVehicule', '/AdminAddVehicule', '/addSecteur', '/quesEntrep', '/actionfichierdll', '/messSupport', '/logView', '/adminUser', '/addEntreprise', '/adminEntreprises', '/addUser', '/adminaction', '/formulaireAction', '/planAction', '/entreprise', '/Accident', '/login', '/statistiques'].includes(location.pathname) &&
